        ...
        void UpdateImposterHandler()
        {
            ...
            if (useFading)
            {
                ...
                if (_fadeNoiseTexture == null)
                    Debug.LogError("Noise texture is NULL!!! You must specified the noise texture for correct imposter fading. Example noise texture located at ImposterSystem/Textures/Noise.psd \n");
